...
PARAMETER {
	...
	kon     = 139.87    (/ms/mM)        : unbound receptor ligand-binding rate
    koff    = 4.05      (/ms)           : bound receptor ligand-unbinding rate
    CC      = 54.54     (/ms)           : bound receptor cleft closing rate
    CO      = 10.85     (/ms)           : bound receptor cleft opening rate
    Beta	= 102.37    (/ms)	        : channel opening rate
    Alpha   = 111.66    (/ms)           : open channel closing rate
