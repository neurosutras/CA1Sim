...
#SBATCH -o parallel_optimize_synaptic_integration_091217.%j.o
#SBATCH -e parallel_optimize_synaptic_integration_091217.%j.e
...
sleep 1
sleep 60
ibrun -n 2000 ipengine --mpi=mpi4py --cluster-id=$cluster_id &
sleep 1
sleep 180
