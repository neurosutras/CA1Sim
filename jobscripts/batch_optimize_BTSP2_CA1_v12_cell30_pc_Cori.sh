...
#SBATCH -J optimize_BTSP2_CA1_v12_cell30_20180501
#SBATCH -o /global/cscratch1/sd/aaronmil/BTSP/logs/optimize_BTSP2_CA1_v12_cell30_20180501.%j.o
#SBATCH -e /global/cscratch1/sd/aaronmil/BTSP/logs/optimize_BTSP2_CA1_v12_cell30_20180501.%j.e
#SBATCH -q premium
#SBATCH -N 7
#SBATCH -L SCRATCH
#SBATCH -C haswell
