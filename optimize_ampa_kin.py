...
def nmda_kinetics_error(x, syn_type, equilibrate, target_val, target_range, plot=0):
    ...
    print('kon, koff, Beta, Alpha: %.4f, %.4f, %.4f, %.4f' % (x[0], x[1], x[2], x[3]))
...
target_val = {'Ro': 0.6, 'rise_tau': -0.1, 'decay_tau': -1.}
target_range = {'Ro': 0.025, 'rise_tau': 0.01, 'decay_tau': -0.05}

#the initial guess
# x = [kon, koff, Beta, Alpha]
x0 = [10., 50., 45., 10.]  # Milstein 2007
#x0 = [18.7173, 18.5095, 19.2338, 6.4123]  # result from blocksize = 0.5, niter = 720, interval = 20
