...
def calculate_plasticity_signal(x, local_kernel, global_kernel, spike_trains, induction, plot=False):
    ...
    return plasticity_signal, saturation_factor, max_global_signal
...
def ramp_error_parametric(x, xmin, xmax, input_matrix, spike_trains, ramp, induction=None, transform=None,
    ...
    delta_weights, saturation_factor, global_signal_peak = calculate_plasticity_signal(x, local_kernel, global_kernel,
    ...
    if full_output:
        return local_kernel, global_kernel, plasticity_signal, weights, model_ramp, model_baseline, this_kernel_scale, \
               saturation_factor, global_signal_peak, Err
    else:
        return Err
...
x0['1'] = [1.385E+01, 5.000E+02, 1.927E+02, 2.068E+02, 1.500E+00]  # Error: 9.219E+04
x0['2'] = [3.794E+02, 5.000E+02, 1.444E+01, 1.002E+02, 1.500E+00]  # Error: 2.123E+04
x0['3'] = [9.350E+01, 1.175E+03, 2.188E+02, 3.590E+02, 7.540E-01]  # Error: 4.967E+03
x0['4'] = [1.490E+02, 5.000E+02, 1.212E+01, 1.541E+02, 8.539E-01]  # Error: 7.277E+03
x0['5'] = [1.046E+01, 2.438E+03, 3.000E+02, 7.026E+02, 1.494E+00]  # Error: 9.740E+04
x0['6'] = [4.124E+02, 1.014E+03, 1.030E+01, 1.853E+02, 7.602E-01]  # Error: 2.187E+04
x0['7'] = [1.053E+01, 5.000E+02, 2.883E+02, 2.8831E+02, 1.500E+00]  # Error: 6.293E+05
...
for induction in position:
    ...
    local_kernel[induction], global_kernel[induction], plasticity_signal[induction], weights_parametric[induction], \
        ...
        global_signal_peak, Err = ramp_error_parametric(x1, xmin1, xmax1, input_matrix, successes, ramp, induction,
...
with h5py.File(data_dir+output_filename+'.hdf5', 'a') as f:
    ...
    f['long_spont'][cell_id].attrs['global_signal_peak'] = global_signal_peak
