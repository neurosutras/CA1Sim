...
Magee 1995, Bittner et al., 2012 in the presence of Ih. Implements an exponential gradient of ghbar along trunk, which
...
def rinp_error(x, plot=0):
    ...
    # x = [soma.ghbar, trunk.ghbar slope, trunk.ghbar tau]
...
# x = [soma ghbar, trunk.ghbar_h slope, trunk.ghbar_h tau]
x0 = [5e-5, 7.56e-8, 17.]
