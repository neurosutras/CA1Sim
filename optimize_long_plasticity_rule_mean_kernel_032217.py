...
def ramp_error_parametric(x, xmin, xmax, input_matrix, complete_rate_maps, ramp, induction=None, transform=None,
    ...
    local_kernel, global_kernel = build_kernels(np.append(x0['mean'], x), plot)
    delta_weights = calculate_plasticity_signal(np.append(x0['mean'], x), local_kernel, global_kernel,
