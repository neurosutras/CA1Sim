...
def build_kernels(x, plot=False):
    ...
    :param x: array: [filter_ratio, global_scale]
    :param plot: bool
    :return: array, array
    """
    filter_ratio = x[0]
...
def ramp_error_cont(x, xmin, xmax, ramp, induction=None, plot=False, full_output=False):
    ...
    :param x: array [filter_ratio, kernel_scale]
    :param xmin: array
    :param xmax: array
    :param ramp: array
    :param induction: int: key for dicts of arrays
...
local_decay_tau = 100.
global_rise_tau = 10.
global_decay_tau = 100.

x0 = {}

x0['1'] = [1.500E+00, 2.851E-03]  # Error: 1.0992E+04
x0['2'] = [1.000E+00, 1.529E-02]  # Error: 1.5884E+05
x0['3'] = [1.000E+00, 2.471E-03]  # Error: 2.3560E+05
x0['4'] = [1.035E+00, 6.953E-03]  # Error: 3.8239E+05
x0['5'] = [1.004E+00, 3.897E-03]  # Error: 1.1649E+05
x0['6'] = [1.000E+00, 7.814E-03]  # Error: 7.0562E+05
x0['7'] = [1.500E+00, 2.670E-02]  # Error: 5.8322E+05
...
ax0.plot(binned_x, model_ramp, label='Short model', color='r', linewidth=2)
