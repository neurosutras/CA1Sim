...
def plot_expected_vs_actual_traces(expected_filename, actual_filename, path_index, plot_every=3, max_num=22,
                                   interval=0.3, rec_loc='soma', dt=0.02):
    """
    ...
    for i in range(len(expected_traces)):
        ...
        actual_trace = actual_traces[i]
        axes[1].plot(np.arange(-10., len(actual_trace) * dt - 10., dt), actual_trace, c='k')
    axes[0].legend(['Expected Linear Summation'], loc='best', frameon=False, framealpha=0.5)
    axes[1].legend(['Actual Summation'], loc='best', frameon=False, framealpha=0.5)
...
def plot_phase_precession(t_array, phase_array, title, fit_start=1500., fit_end=3000.):
    ...
    for i, t in enumerate(t_array):
        ...
        plt.scatter(t, phases, c='lightgray')  # colors[i])
