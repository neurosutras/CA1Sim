...
PARAMETER {
    ...
    f = 1.786           (1)     < 0, 1e9 >      : additive facilitation per spike
    tau_F = 66.242      (ms)    < 1e-9, 1e9 >   : rate of decay back to baseline following facilitation
    d1 = 0.883          (1)     < 0, 1 >        : multiplicative fast depression per spike
    tau_D1 = 105.858     (ms)    < 1e-9, 1e9 >   : rate of decay back to baseline following fast depression
