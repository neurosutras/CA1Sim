...
PARAMETER {
	...
	P0 = 0.18       (1)     < 0, 1 >        : basal release probability
    f = 0.92        (1)     < 0, 1e9 >      : additive facilitation per spike
    tau_F = 105.5   (ms)    < 1e-9, 1e9 >   : rate of decay back to baseline following facilitation
    d1 = 0.64       (1)     < 0, 1 >        : multiplicative fast depression per spike
    tau_D1 = 2.7    (ms)    < 1e-9, 1e9 >   : rate of decay back to baseline following fast depression
