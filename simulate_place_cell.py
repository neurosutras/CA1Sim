...
# a unique random seed can be used to shuffle the number and locations of synapses, and the place field locs of the
# presynaptic CA3 inputs (like simulating a different cell with the same morphology)
if len(sys.argv) > 1:
...
# append a label when exporting data to .hdf5:
if len(sys.argv) > 3:
