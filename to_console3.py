...
def setup_cell(verbose=False):
    ...
    sim.append_rec(cell, cell.tree.root, param='_ref_cai', description='cai')
    sim.append_rec(cell, cell.tree.root, param='_ref_cao', description='cao')
    sim.append_rec(cell, cell.tree.root, param='_ref_e_ca_Ca', description='e_ca')
    sim.append_rec(cell, cell.tree.root, param='_ref_i_CadepK', description='i_CadepK')
