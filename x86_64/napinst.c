...
extern Memb_func* memb_func;
 ...
 "setdata_napinst", _hoc_setdata,
 "settables_napinst", _hoc_settables,
 0, 0
};
...
#define sigmap sigmap_napinst
 double sigmap = 3;
#define thetap thetap_napinst
 double thetap = -47;
#define usetable usetable_napinst
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_napinst", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "thetap_napinst", "mV",
 "sigmap_napinst", "mV",
 "gbar_napinst", "mho/cm2",
 "gna_napinst", "mho/cm2",
 0,0
};
 static double delta_t = 1;
 static double foo0 = 0;
 /* connect global user variables to hoc */
 static DoubScal hoc_scdoub[] = {
 "thetap_napinst", &thetap_napinst,
 "sigmap_napinst", &sigmap_napinst,
 "usetable_napinst", &usetable_napinst,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 9, 4);
 	...
 	ivoc_help("help ?1 napinst /Users/huntd/Desktop/CA3project/x86_64/napinst.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 static double *_t_pinf;
static int _reset;
static char *modelname = "Sodium persistent current for Golomb et al., J Neurophysiol 96:1912-1926, 2006";
...
static int  _f_settables ( _threadargsprotocomma_ double _lv ) {
   pinf = 1. / ( 1. + exp ( - ( _lv - thetap ) / sigmap ) ) ;
    return 0; }
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = &(foo) - _p;  _dlist1[0] = &(Dfoo) - _p;
   _t_pinf = makevector(642*sizeof(double));
_first = 0;
}
